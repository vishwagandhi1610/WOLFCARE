...
<html lang="en" dir="ltr">
    ...
    <script>
      function showUser(str) {
        ...
        if (str == '') {
          ...
          xmlhttp.open("GET", "get_doctors_admin.php?search="+str, true);
          xmlhttp.send();
        }
      }
    </script>
  ...
  <body>
    ...
    <div class="sidebar">
      ...
      <a href="http://127.0.0.1:5501/code/medical-rules/admin_rules.html"><i class="fas fa-diagnoses"></i><span>Symptoms</span></a>
      <a href="show_appointment_admin.php"><i class="far fa-calendar-check"></i></i><span>Appointments</span></a>
      <!-- <a href="#"><i class="fas fa-info-circle"></i><span>About us</span></a> -->
    ...
    <!--Content-->
    <form action="doctor-info-admin.php" method="get">
